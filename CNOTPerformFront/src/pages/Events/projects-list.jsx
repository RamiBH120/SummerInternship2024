...
const ProjectsList = () => {
  //meta title
  document.title = "Liste des évènements | CNOT PERFORM";
            ...
            <Col lg="12">
              <div>
                <div className="table-responsive">
                  <Table className="project-list-table table-nowrap table-borderless align-middle">
                    <thead>
                      <tr>
            ...
            <Col xs="12">
              <div className="my-3 text-center">
                <Link to="#" className="text-success">
                  <i className="bx bx-loader bx-spin font-size-18 me-2 align-middle" />
                  Load more
                </Link>
              </div>
            </Col>
